...
{ 
    ...
    { 
        ...
        [HttpGet]
        [Route("/HackCrisisPW/HackCrisis.EveTeam/1.0.0/example")]
        [ValidateModelState]
        ...
        /// </summary>
        /// <remarks>na</remarks>
        /// <response code="200">pnig2 OK</response>
        [HttpGet]
        [Route("/HackCrisisPW/HackCrisis.EveTeam/1.0.0/ping2")]
        [ValidateModelState]
        [SwaggerOperation("Ping2Get")]
        public virtual IActionResult Ping2Get()
        { 
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200);
        ...
        /// <response code="200">OK</response>
        [HttpGet]
        [Route("/HackCrisisPW/HackCrisis.EveTeam/1.0.0/ping")]
        [ValidateModelState]
